                    ...
                    <div className="p-6">
                        <div className="flex items-centre space-x-4">
                            <div className="w-12 h-12 rounded-full bg-green-500 ">
                                <div className="text-2xl text-white justify-center pl-4 pt-1.5">{name[0]}</div>
                            </div>
                            <h3 className="text-2xl font-semibold pt-1">{name}</h3>
                        </div>
                        <div className="space-y-4">
                            ...
                            className="justify-centre rounded-md text-sm font-medium ring-offset-background transition-colors h-10 px-4 py-2 w-full bg-green-500 text-white">
                                Initiate Transfer
                            </button>
                        </div>
                    </div>
